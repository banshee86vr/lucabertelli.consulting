export const ui = {
  en: {
    ...
    'index.services.4.text': "Creation of training courses on topics around the SecDevOps world and tools belonging to the cloud-native landscape. All the training is tailor-made to fit the customer's needs, considering the experience level owned by the audience and the existing ecosystem of adopted tools and practices.",
