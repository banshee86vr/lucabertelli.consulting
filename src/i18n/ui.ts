export const ui = {
  en: {
    ...
    'index.services.2.title': 'Toolchain Selection and Implementation',
    'index.services.2.text': "Identification of the correct tool set and technologies to support continuous integration, continuous delivery (CI/CD), automated testing, monitoring, and infrastructure as code (IaC).",
    'index.services.3.title': 'Cloud Adoption and Migration',
    'index.services.3.text': 'Support during the adoption of cloud computing platforms and guide through migrating applications and infrastructure to the cloud.',
    'index.services.4.title': 'Security Integration',
    'index.services.4.text': 'Integration of security practices and approaches into the secure software development lifecycle (DevSecOps) to ensure safe processes from the development phase until the deployment on the target environment.',
  ...
  it: {
    ...
    'index.services.2.title': 'Composizione Toolchain e Implementazione',
    'index.services.2.text': "Proposizione ed implementazione della corretta combinazione di tools e tecnologie per supportare la continuous integration e continuous delivery (CI/CD), test automatizzati, monitoring e infrastructure as code (IaC).",
    'index.services.3.title': 'Cloud Adoption e Migration',
    'index.services.3.text': "Assistenza nell'adozione delle piattaforme di Cloud Computing e affiancamento nella migrazione delle applicazioni e dell'infrastrutura in cloud.",
    'index.services.4.title': 'Security Integration',
    'index.services.4.text': 'Integrazione delle pratiche legate alla security e degli approcci che garantiscono il secure software development lifecycle (DevSecOps) per garantire processi sicuri partendo dalle fasi di sviluppo fino al rilascio negli ambienti target.',
